            ...
            parallel {
                stage('Run REST API') {
                    steps {
                        ...
                        bat 'start cmd /k "C:\\Users\\shaam\\AppData\\Local\\Programs\\Python\\Python312\\python.exe rest_app.py"'
                    }
                }
                ...
                stage('Run Web Server') {
                    steps {
                        ...
                        bat 'start cmd /k "C:\\Users\\shaam\\AppData\\Local\\Programs\\Python\\Python312\\python.exe web_app.py"'
                    }
                }
            }
        }

pipeline {
    ...
    stages {
        ...
        //             docker rmi %DOCKER_REPO%/backend:%DOCKER_IMAGE_VERSION%
        //             docker rmi %DOCKER_REPO%/frontend:%DOCKER_IMAGE_VERSION%
        //             docker rmi %DOCKER_REPO%/mysql:%DOCKER_IMAGE_VERSION%
        //             """
        //         }
        //     }
        // }
